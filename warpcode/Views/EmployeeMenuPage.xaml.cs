        ...
        private async void Logout_Tapped(object sender, EventArgs e)
        {
            try
            {
                if (!App.CheckedIn)
                {
                    ...
                    {
                        await App.Current.MainPage.DisplayAlert("Alert", ResourceConstants.SomethingWentWrong, ResourceConstants.Ok);
                        //UserDialogs.Instance.Toast(Resource.SomethingwentWrong);
                    }
                }
                else
                {
                    await App.Current.MainPage.DisplayAlert("Alert", ResourceConstants.YouMustCheckOutFirst, ResourceConstants.Ok);
